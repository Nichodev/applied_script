...
kopierea alla filer i en katalog
flytta filer av en viss typ 
"""
...
def main():
    ...
    parser.add_argument('-o', '--operation', choices=['list', 'copy', 'move', 'delete'], required=True, help='Choose operation')
    ...
    if args.operation == 'list':
        ...
        print('Files in directory: {args.directory}: ')
        for file in files:
            print(file)
